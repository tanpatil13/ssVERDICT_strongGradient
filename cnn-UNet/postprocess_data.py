...
def plot_param_maps(f_ic_map, f_ees_map, r_map, f_vasc_map, cellularity_map, zslice, th_gradient_strength, timestamp, target_dir, control_type, control_id=None, cmap='jet'):
    """
...
def generate_param_maps(f_ic_pred, f_ees_pred, r_pred, image_mask, th_gradient_strength, timestamp, target_dir, zslice, control_type, control_id=None, prostate_mask_dir=None, prostate_mask_file_pattern=None):
    ...
    f_ic_map, f_ees_map, f_vasc_map, r_map, cell_map = f_ic, f_ees, f_vasc, r, cellularity
