...
def main(timestamp):
    ...
    perform_training_inference(
        ...
        image_G300_file_pattern=image_G300_file_pattern,
        x_bvec_G300_file_pattern=x_bvec_G300_file_pattern,
        y_bvec_G300_file_pattern=y_bvec_G300_file_pattern,
        z_bvec_G300_file_pattern=z_bvec_G300_file_pattern,
        image_G80_file_pattern=image_G80_file_pattern,
        x_bvec_G80_file_pattern=x_bvec_G80_file_pattern,
        y_bvec_G80_file_pattern=y_bvec_G80_file_pattern,
        z_bvec_G80_file_pattern=z_bvec_G80_file_pattern,
        image_G40_file_pattern=image_G40_file_pattern,
        x_bvec_G40_file_pattern=x_bvec_G40_file_pattern,
        y_bvec_G40_file_pattern=y_bvec_G40_file_pattern,
        z_bvec_G40_file_pattern=z_bvec_G40_file_pattern,
        Delta_G300=Delta_G300, delta_G300=delta_G300, gradient_strength_G300=gradient_strength_G300,
        Delta_G80=Delta_G80, delta_G80=delta_G80, gradient_strength_G80=gradient_strength_G80,
        Delta_G40=Delta_G40, delta_G40=delta_G40, gradient_strength_G40=gradient_strength_G40,
        th_bvals=th_bvals,
        timestamp=timestamp
    )
