...
def perform_training_inference(grad_dataset_dir, train_data_dir, val_data_dir, healthy_test_data_dir, patient_test_data_dir,
    ...
    train_dataloader, val_dataloader, healthy_test_dataloader, patient_test_dataloader = create_dataloaders(train_preprocessed_image_data, val_preprocessed_image_data, healthy_test_preprocessed_image_data,
                                                                                                            patient_test_preprocessed_image_data, batch_size)
    ...
    model = ssVERDICT_UNet(th_bvals_all_grad, Delta.to(device), delta.to(device), gradient_strength.to(device), nparams, device, batch_size).to(device)
    ...
    print("Model Summary: ")
    print(summary(model, input_size=(batch_size, train_preprocessed_image_data.shape[1], train_preprocessed_image_data.shape[2], train_preprocessed_image_data.shape[3])))
    ...
    healthy_test_f_ic_map, healthy_test_f_ees_map, healthy_test_r_map, healthy_test_f_vasc_map, _ = generate_param_maps(healthy_test_f_ic_pred, healthy_test_f_ees_pred, healthy_test_r_pred, healthy_test_image_G300_mask, timestamp, 7, "healthy")
    ...
    patient_test_f_ic_map, patient_test_f_ees_map, patient_test_r_map, patient_test_f_vasc_map, _ = generate_param_maps(patient_test_f_ic_pred, patient_test_f_ees_pred, patient_test_r_pred, patient_test_image_G300_mask, timestamp, 8, "patient")
