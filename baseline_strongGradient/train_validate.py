...
def train_model(model, train_dataloader, val_dataloader, criterion, optmizier, num_epochs='30', device='cuda', timestamp=None, scheduler=None):
    """
...
def perform_training_inference(train_data_dir, val_data_dir, healthy_test_data_dir, patient_test_data_dir, Delta, delta, gradient_strength, th_bvals, 
                               grad_dataset_dir, image_file_pattern, x_bvec_file_pattern, y_bvec_file_pattern, z_bvec_file_pattern,
    ...
    Args:
        ...
        Delta: Diffusion time in ms.
        delta: Pulse duration in ms.
        gradient_strength: Gradient strength in mT/m.
        th_bvals: Theoretical b-values in ms/µm^2.
        grad_dataset_dir: Directory containing the gradient dataset.
        image_file_pattern: Pattern to match image files.
        x_bvec_file_pattern: Pattern to match x b-vector files.
    ...
    generate_param_maps(healthy_test_f_ic_pred, healthy_test_f_ees_pred, healthy_test_r_pred, healthy_test_image_mask, th_gradient_strength, timestamp, "healthy")
    ...
    generate_param_maps(patient_test_f_ic_pred, patient_test_f_ees_pred, patient_test_r_pred, patient_test_image_mask, th_gradient_strength, timestamp, "patient")